...
```{r}
write.csv(dat_pigS, file = here("roboflow/data/clean/2024_05_28_pigmentation.csv"),row.names = F)
...
write.csv(dat_pigS2, file = here("roboflow/data/clean/2024_05_28_pigmentation_nogroup.csv"),row.names = F)
```
